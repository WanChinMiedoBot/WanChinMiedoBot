...
def test_json_user():
    ...
    u = types.de_json(types.User, jsonstring)
...
def test_json_message():
    ...
    msg = types.de_json(types.Message, jsonstring)
...
def test_json_Document():
    ...
    doc = types.de_json(types.Document, json_string)
...
def test_json_UserProfilePhotos():
    ...
    upp = types.de_json(types.UserProfilePhotos, json_string)
...
def test_json_contact():
    ...
    contact = types.de_json(types.Contact, json_string)
...
def test_json_voice():
    ...
    voice = types.de_json(types.Voice, json_string)
...
def test_json_update():
    ...
    update = types.de_json(types.Update, json_string)
...
def test_json_chat():
    ...
    chat = types.de_json(types.Chat, json_string)
